...
let columnMap = footerDataArray.map((element) => {
    return (
        ...
        <div className="row">
            ...
            <p key={element.AuthorData} className="padding-zero pb-3">{element.AuthorData}</p>
            </div>
            ...
            <p key={element.AuthorData} className="padding-zero pb-3"><a href={"tel:" + element.AuthorData3}>{element.AuthorData3}</a></p>
            </div>
            <form></form>
        </div>
        </div>
